...
from utils import get_dest_midi_path, write_list
...
def convert_batch(files: list, new_dir: str, debug=False):
    failed_files = []
...
def main():
    ...
    failed_files = convert_batch(files, output_path, debug=True)
    ...
    # convert_batch([test_file], "data", debug=True)
